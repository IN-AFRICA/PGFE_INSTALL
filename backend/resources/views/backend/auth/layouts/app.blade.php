                    ...
                    <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                        <div class="flex items-center justify-center z-1">
                            ...
                            <div class="flex flex-col items-center max-w-xs text-center">
                                <div class="mb-2 text-2xl font-bold tracking-tight text-white/90">
                                    {{ config('app.name', 'PGFE') }}
                                </div>
                                <p class="text-sm text-gray-300/80 dark:text-white/70">
                                    {{ __('Plateforme de gestion scolaire PGFE') }}
                                </p>
                            </div>
                        </div>
                    </div>
