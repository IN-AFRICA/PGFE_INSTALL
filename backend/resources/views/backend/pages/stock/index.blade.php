...
@section('admin-content')
    <div class="max-w-xl mx-7">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="#" class="px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700 font-medium text-sm shadow">Ajouter un article</a>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full border rounded-lg bg-white dark:bg-gray-900 text-xs align-middle">
                ...
                <tbody>
                    {{-- À remplir avec les articles de stock --}}
                </tbody>
            </table>
        </div>
    </div>
