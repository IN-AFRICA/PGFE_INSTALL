<x-layouts.modules-layout :breadcrumbs="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'Personnel', 'url' => '#']]">
    <x-backend.pages.module-sidebar-layout 
        logoIcon="lucide:id-card"
        :menuItems="[
            ['label' => 'Tableau de bord', 'icon' => 'lucide:layout-grid', 'url' => route('admin.personnels.index'), 'route_prefix' => 'admin.personnels.index'],
            ['label' => 'Saisie préalable', 'icon' => 'lucide:file-text', 'url' => '#', 'active' => false],
            ['label' => 'Saisie des opérations', 'icon' => 'lucide:clipboard-list', 'url' => route('admin.personnels.index'), 'active' => true],
        ]"
    >
        <div class="space-y-6">
            <!-- Premium Header -->
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-800 p-8 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700">
                <div>
                    <h1 class="text-3xl font-black text-gray-800 dark:text-white flex items-center gap-2">
                        <iconify-icon icon="lucide:id-card" class="text-emerald-500" width="36"></iconify-icon>
                        Gestion du Personnel
                    </h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium">Administrez les agents et le personnel académique de vos établissements.</p>
                </div>
                <div class="flex items-center gap-3">
                    <div class="hidden sm:flex flex-col items-end mr-4">
                        <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Effectif RH</span>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="p-8 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                    <h2 class="text-xl font-black text-gray-800 dark:text-white">Liste du personnel</h2>
                    <button disabled title="Création non implémentée" class="opacity-50 cursor-not-allowed inline-flex items-center justify-center gap-2 rounded-2xl bg-violet-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-violet-600/20 transition-all">
