    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-800 p-8 rounded-[2.5rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2 font-medium">Répertoriez les communes appartenant aux provinces.</p>
            </div>
            <a href="{{ route('admin.communes.create') }}" class="group inline-flex items-center justify-center gap-2 rounded-2xl bg-violet-600 px-8 py-4 text-sm font-black text-white hover:bg-violet-700 shadow-xl shadow-violet-600/20 transition-all hover:-translate-y-1">
                ...
                <table class="w-full text-left">
                    <thead>
                        <tr class="bg-gray-50/50 dark:bg-gray-950/50 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <th class="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Nom de la Commune</th>
                            ...
                            <tr class="group hover:bg-violet-50/20 dark:hover:bg-violet-900/10 transition-colors">
                                ...
                                <td class="px-8 py-6 text-right">
                                    <div class="flex justify-end items-center gap-3">
                                        <a href="{{ route('admin.communes.edit', $c) }}" class="h-10 w-10 flex items-center justify-center rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-400 hover:bg-violet-600 hover:text-white transition-all shadow-sm">
                                            <iconify-icon icon="lucide:pen-line" width="20"></iconify-icon>
                                        </a>
                                        <form action="{{ route('admin.communes.destroy', $c) }}" method="POST" onsubmit="return confirm('Supprimer cette commune ?')" class="inline-block">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="4" class="px-8 py-20 text-center">
                                    <div class="flex flex-col items-center gap-4">
                                        ...
                                        <p class="text-gray-400 font-bold">Aucune commune enregistrée.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
